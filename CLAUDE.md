...
This command **requires** the project directory as an argument via `/home/autocoder/generations`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/home/autocoder/generations/prompts/app_spec.txt` and `/home/autocoder/generations/prompts/initializer_prompt.md`

If `/home/autocoder/generations` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/home/autocoder/generations/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/home/autocoder/generations/prompts/app_spec.txt`
...
**Output path:** `/home/autocoder/generations/prompts/initializer_prompt.md`
...
**Output path:** `/home/autocoder/generations/prompts/.spec_status.json`
...
> "Your specification files have been created in `/home/autocoder/generations/prompts/`!
>
> **Files created:**
> - `/home/autocoder/generations/prompts/app_spec.txt`
> - `/home/autocoder/generations/prompts/initializer_prompt.md`
>
